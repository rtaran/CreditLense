...
# Get upload folder from environment variable or use default
UPLOAD_FOLDER = os.getenv("UPLOAD_FOLDER", "./data/uploads")

# Create directories for uploads
METHODOLOGY_DIR = Path(UPLOAD_FOLDER) / "methodology"
MEMO_FORMAT_DIR = Path(UPLOAD_FOLDER) / "memo_format"
